...
function MessageDrawer({ msg, onClose, onStatusChange, saving }) {
    if (!msg) return null;
    return (
        <>
            ...
            <div style={{
                ...
                <div style={{ flex: 1, overflowY: 'auto', padding: '24px' }}>
                    <p style={{ fontSize: '0.78rem', fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 10 }}>
                        Message
                    </p>
                    <div style={{
                ...
                <div style={{
                    ...
                    display: 'flex', gap: 10, flexShrink: 0, background: '#f8fafc',
                }}>
...
export default function MessagesPage() {
    ...
    // Mark as Read automatically when opening a message
            ...
            <div style={{ background: '#fff', borderRadius: 14, border: '1px solid #e2e8f0', overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.05)' }}>
                {loading ? (
                    <div style={{ padding: '60px', textAlign: 'center', color: '#94a3b8' }}>
                        <div style={{ width: 32, height: 32, border: '3px solid #e2e8f0', borderTopColor: '#2563eb', borderRadius: '50%', animation: 'ad-spin 0.8s linear infinite', margin: '0 auto 12px' }} />
                        Loading messages…
                    </div>
                ) : error ? (
                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                        <thead>
                            <tr style={{ borderBottom: '2px solid #f1f5f9' }}>
                                {['Sender', 'Subject', 'Preview', 'Status', 'Received', ''].map(h => (
                                    <th key={h} style={{
